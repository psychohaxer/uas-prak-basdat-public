<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="dashboard.aspx.vb" Inherits="UAS_Basis_Data.dashboard" %>
...
&nbsp;SEMESTER
            ...
            <tr>
                ...
                <td style="text-transform: capitalize">
                    ...
                    <asp:SqlDataSource ID="dsDosen" runat="server" 
                        ...
                        SelectCommand="SELECT DISTINCT dosen.nama, dosen.id FROM dosen INNER JOIN makul ON makul.id = dosen.id WHERE (makul.semester = @semester)">
                        <SelectParameters>
                ...
                <td style="text-transform: capitalize">
                    ...
                    <asp:SqlDataSource ID="dsMakul" runat="server" 
                        ...
                        SelectCommand="SELECT [judul], [kode], [semester], [id] FROM [makul] WHERE (([semester] = @semester) AND ([id] = @id)) ORDER BY [semester], [judul]">
                        <SelectParameters>
                            <asp:ControlParameter ControlID="ddlSemester" Name="semester" 
                                PropertyName="SelectedValue" Type="Decimal" />
                            <asp:ControlParameter ControlID="ddlDosen" Name="id" 
                                PropertyName="SelectedValue" Type="Decimal" />
                        </SelectParameters>
                    </asp:SqlDataSource>
                </td>
    ...
    <div style="table-layout: auto; font-family: Arial, Helvetica, sans-serif;">
        <asp:GridView ID="dgv" runat="server" CellPadding="4" ForeColor="#333333" 
            GridLines="None">
    ...
    <div style="font-family: Arial, Helvetica, sans-serif; font-size: medium;">
        <asp:DropDownList ID="ddlDosenSKS" runat="server" DataSourceID="dsDosenSKS" 
            DataTextField="nama" DataValueField="id" AutoPostBack="True">
        </asp:DropDownList> 
        <asp:SqlDataSource ID="dsDosenSKS" runat="server" 
            ConnectionString="<%$ ConnectionStrings:uasbasdatConnectionString %>" 
            SelectCommand="SELECT * FROM [dosen] ORDER BY [nama]"></asp:SqlDataSource>
        &nbsp&nbsp SKS: 
